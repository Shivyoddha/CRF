...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { created_on: @announcement.created_on, text: @announcement.text } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { created_on: @announcement.created_on, text: @announcement.text } }
